...
trainingrows = sort(sample(nrow(training), size=2000, replace=FALSE))
...
mtryValues <- c(5, 10, 20, 32, 50, 100, 250, 500)
# set.seed(476)
...
trainPerf <- rbind(j48, part, tb, c5) #rf, bst, c5)

library(lattice)
#library(reshape2)
trainPerf <- reshape2::melt(trainPerf)
