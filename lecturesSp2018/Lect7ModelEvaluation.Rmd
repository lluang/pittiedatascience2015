...
- `caret` develops a consistant interface between machine learning methods and model evaluation methods.
...
-  Full list with arguements at https://topepo.github.io/caret/modelList.html
