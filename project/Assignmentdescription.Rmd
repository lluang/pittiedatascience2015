...
Each assignment for the project consists of a short paper and a presentation. The paper should be written in R Markdown format (delivered as a pdf) and the presentation should be written in R Presentation format (delivered as HTML or PDF)
...
4.  First application of an applicable machine learning method for the problem.
5.  Hypothesis(es) to be tested for the final project.
6.  Plan of work.
