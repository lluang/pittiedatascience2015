...
library(ROCR)
library(DMwR)
# Note: BPresults.Rdata, LOFresults.Rdata, and ORHresults.Rdata are found here: http://www.dcc.fc.up.pt/~ltorgo/DataMiningWithR/extraFiles.html
```
```{r}
data(pottery)
summary(pottery)
