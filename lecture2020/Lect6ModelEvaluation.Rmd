...
- Split data for cross-evaluations
- Look at both performance measures and standard deviation
...
- Plot the prediction and compare to actual
```{r}
carsplot <- cars2010
carsplot$Pred1 <- lmFit1$finalModel$fitted.values
ggplot(carsplot) + geom_point(aes(Pred1, FE)) + geom_smooth(aes(Pred1, FE), method="lm") +
    ggtitle("Linear Model") + xlab("Predictions") + ylab("True Values") 
```
...
- Note: parenthesis forces printing results along with saving to variable
