...
- Understand the implications of your results and communicate with clients.
...
-  Define the problem.
-  What is a usable result.
-  How do you present the results so clients can understand and act on them.
...
-  How will the results be presented and used?
...
-  How will the organization react to different results?
...
-  Data can come from many sources and there may be many data elements
