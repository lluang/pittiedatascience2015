---
title: "Clustering & Class Imbalance"
...
-  NDTP is unitless, so can be used to compare differnt products.
```{r}
...
-  Use 70%/30% division of the data set
...
-  Generate an outlyingness score for each case by estimating its degree of isolation with its local neighborhood.
-  *core distance* - distance between a point *p* and its *k*th nearest neighbor.
-  *reachability distance* - The maximum of the core distance of $p_1$ and the distance between $p_1$ and $p_2$
...
-  $OR_h$ method uses a hierarchical agglomerative clustering algorithm to obtain a *dendrogram*.
...
-  Outliers will tend to offer resistance to merging, and when they do, will cause the new group to be changed in size.
...
PRcurve(PTs.nb[,,1],PTs.nb[,,2],
        main='PR curve',lty=1,col='black', xlim=c(0,1),ylim=c(0,1),
        avg='vertical')
PRcurve(PTs.orh[,,1],PTs.orh[,,2],
...
CRchart(PTs.nb[,,1],PTs.nb[,,2],
        main='Cumulative Recall curve',lty=1,col='black', xlim=c(0,1),ylim=c(0,1),
        avg='vertical')
CRchart(PTs.orh[,,1],PTs.orh[,,2],
        add=T,lty=2,col='grey',
        avg='vertical')        
...
save(nbs.res, file="nbs.res.Rdata")
```
...
PRcurve(PTs.nbs[,,1],PTs.nbs[,,2],
        ...
        avg='vertical')
PRcurve(PTs.orh[,,1],PTs.orh[,,2],
        add=T,lty=3,col='lightgrey',
        avg='vertical')        
legend('topright',c('NaiveBayes','smoteNaiveBayes', 'ORh'),
       lty=c(1,2,3),col=c('black','red', 'lightgrey'))
CRchart(PTs.nb[,,1],PTs.nb[,,2],
        main='Cumulative Recall curve',lty=1,col='black', xlim=c(0,1),ylim=c(0,1),
        avg='vertical')
...
PRcurve(PTs.nbs[,,1],PTs.nbs[,,2],
        add=T,lty=2,col='red',
        avg='vertical')
legend('topright',c('NaiveBayes', 'NBSMOTE', 'AdaBoostM1', 'ORh'),
       lty=c(1,2,2,3),col=c('black', 'red', 'blue', 'grey'))
CRchart(PTs.nb[,,1],PTs.nb[,,2],
        main='PR curve',lty=1,xlim=c(0,1),ylim=c(0,1),
        avg='vertical')
CRchart(PTs.orh[,,1],PTs.orh[,,2],
...
CRchart(PTs.nbs[,,1],PTs.nbs[,,2],
        add=T,lty=2,col='red',
        avg='vertical')
legend('bottomright',c('NaiveBayes', 'NBSMOTE', 'AdaBoostM1', 'ORh'),
       lty=c(1,2,2,3),col=c('black','red', 'blue', 'grey'))
```
