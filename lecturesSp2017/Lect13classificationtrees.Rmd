...
- The aim of classification trees is to partition the data into smaller, more homogenous groups.
...
- Purity is defined by maximiizing accuracy or minimizing misclassifications.
...
- Pessimistic pruning focussing on an upper bound on the number of classification errors.
...
- Instead of the regression tree for every iteration of random forest, a classfication tree is used.
