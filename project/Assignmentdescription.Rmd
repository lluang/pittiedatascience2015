...
1.  Proposal and Exploratory data analysis (February 12)
2.  Preliminary data analysis (April 1])
3.  Final report and presentation (April 15)
...
7.  Design and create a single plot that shows the effects of all three independent variables in question 8.  Working with the data - What were difficulties faced while preparing the data for analysis?
