...
1.  Exploratory data analysis (February 20)
2.  Preliminary data analysis (March 20)
3.  Final report and presentation (April 24)
...
6.  Explore the variables applying the five basic plot types at least once each.  Note: the easy way to do this is to take from the five named plot types, but you may find more complex plots are more useful.
